...
RSpec.describe Event do
  ...
  describe 'Object Methods' do
    ...
    it "can add food food_trucks" do
    ...
    it "can guestimate potential revenue" do
      @event.add_food_truck(@food_truck1)
      @event.add_food_truck(@food_truck2)
      @event.add_food_truck(@food_truck3)
    ...
    it "adds more inventory" do
      ...
      expected = {
        @item1 => {
          quantity: 100, food_trucks: [@food_truck1, @food_truck3]
        },
        @item2 => {
          quantity: 7, food_trucks:[@food_truck1]
        },
        @item4 => {
          quantity: 50, food_trucks: [@food_truck2]
        },
        @item3 => {
          quantity: 35, food_trucks: [@food_truck2, @food_truck3]
        },
      }
